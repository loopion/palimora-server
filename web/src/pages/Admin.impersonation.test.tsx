...
beforeEach(() => {
  ...
  vi.stubGlobal('fetch', vi.fn(async (url: string) => {
    ...
    if (url.endsWith('/api/admin/ocr')) return new Response(JSON.stringify({ local_models: [], active_key: 'rec', active_slug: 'rec', active_source: 'fallback', kraken_error: null, recent: [], aggregates: [] }), { status: 200 })
